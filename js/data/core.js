/* ============================================================
   THE SINAI TRAIL — core content: roles, glossary, learn pages,
...
SINAI.ROLES = [
  {
    ...
    blurb: "Judah camps east of the Tent and marches first when the cloud lifts (Num 2:3, 10:14). Your household is well supplied with the silver of Egypt.",
    silver: 1600, mult: 1
  },
  {
    id: "levi", name: "a LEVITE of the clan of Kohath",
    blurb: "You will carry the holy things on your shoulders (Num 7:9). Less silver, more responsibility; a Levite receives no land.",
    silver: 800, mult: 2
  },
  {
    id: "dan", name: "a rear-guard of DAN",
    blurb: "Dan brings up the rear of the whole camp (Num 10:25) so the weak, the sick and the slow walk in the middle. Least silver. Amalek attacks from behind.",
    silver: 400, mult: 3
  }
];
...
SINAI.STORE = [
  ...
  { id: "water", name: "Water-skins (filled)", unit: "days", price: 6, min: 1, max: 30,
    help: "A skin of water per person per day. Three days into the Wilderness of Shur there is no water at all." },
...
/* Pace & rations */
SINAI.PACES = {
  cloud: { name: "Follow the cloud", miles: 12, hp: 0, desc: "March when the cloud lifts, camp when it settles (Num 9:17-23). The whole nation moves as one." },
  ahead: { name: "Push ahead of the cloud", miles: 16, hp: -2, desc: "Faster, but you leave the protection of the camp. Raiders, heat and thirst find the ones who run ahead." },
  lag:   { name: "Lag with the stragglers", miles: 8, hp: 1, desc: "Slow and easy. But the rear is where Amalek 'cut off all who were lagging behind' (Deut 25:18)." }
};
SINAI.RATIONS = {
...
SINAI.LEARN = [
  ...
  ["HOW TO PLAY",
   "It plays like the old Oregon Trail. You lead one household of five inside the great camp. Keep them alive: water, food, health, and — new in this desert — EMUNAH, trust.\n\nEvery choice is a choice the text records someone making. Grumbling is counted. Hoarded manna rots. Gold kept back from the Tent becomes a calf. What you take at Jericho decides what happens at Ai.\n\nPress ENTER to size up the situation. Press M for the map. Press S for sound."],
  ["THE DESERT",
   "It is not sand dunes. It is deep rock canyons — wadis — where you cannot see two hundred yards ahead, where the walls radiate heat 'like baking in an oven,' and where the number one killer is not thirst but the flash flood: if you hear a sound like a train you have forty seconds to two minutes to climb.\n\nShade is a broom bush three feet high with room for one person. Pasture is a tuft of dry grass in the rocks. The desert teaches 'just enough, just in time.' (BEMA 26-29)"],
  ["THE TEACHERS",
   "The Scrolls of Insight in this game quote three teachers by name:\n\nBEMA DISCIPLESHIP (Marty Solomon & Brent Billings) — the Hebrew, the rabbis, the desert itself.\n\nDAVID PAWSON — 'Unlocking the Old Testament': the history, the numbers, the logistics of two million people.\n\nBIBLEPROJECT (Tim Mackie & Jon Collins) — the literary design: tests, Eden replays, the character of God (Ex 34:6-7).\n\nNothing in a Scroll is attributed to a teacher who did not say it."],
  ["WHAT KILLS YOU",
   "Thirst. Heat. The fever. Dysentery. Scorpions in cisterns. Fiery serpents in the Arabah. Amalek at the rear of the line. The wadi at night.\n\nAnd the things that killed the first generation: the calf (3,000), the craving at Kibroth-hattaavah, the vote at Kadesh (every man over twenty), Korah (250 and 14,700 more), Baal Peor (24,000).\n\n'Behold the goodness and the severity of God' — Pawson, part 13."]
];

/* Glossary used by the insight boxes */
SINAI.GLOSS = {
  yada: "YADA — to know by experience, intimately; 'Adam knew his wife.' God tests 'to know what is in your heart.' (BEMA 20)",
  marah: "MARAH — bitter; also rebellious. 'I give you bitter water to see if you are a bitter people.' (BEMA 20)",
  emunah: "EMUNAH / EMET — steadiness, reliability, 'amen.' Moses' hands were EMET when Aaron and Hur held them. (BibleProject)",
  nephesh: "NEPHESH — soul, the whole of you. 'Does God have you, or only when He meets your demands?' (BEMA 21)",
  meod: "MEOD — 'very,' your 'much': every resource you have. The test of Amalek. (BEMA 21)",
  segulah: "SEGULAH — treasured possession. Wedding language, still used at Jewish weddings today. (BEMA 22)",
  midbar: "MIDBAR — wilderness, from DAVAR, 'word': the place of speaking. (BEMA 26)",
  kadosh: "KADOSH — holy, set apart. KADESH is spelled with the same letters. (BibleProject)",
  hotnose: "'HIS NOSE BURNED HOT' — the Hebrew idiom for anger. 'Slow to anger' = EREK APPAYIM, 'long of nostrils.' (BibleProject)",
  chesed: "CHESED — loyal love. EMET — faithfulness. Ex 34:6-7, the most quoted verse in the Old Testament. (BibleProject)",
  zakar: "ZAKAR — remember (14 times in Deuteronomy). SHAKACH — forget (9 times). (BEMA 31)",
  chazak: "CHAZAK VE'EMATZ — be strong and courageous; EMATZ has the sense of quick feet. (BEMA 34)",
  harem: "HAREM — 'devoted': set aside for God, not for you. (BEMA 34, Josh 6:17-19)"
};
