...
(function () {
  ...
  /* ---- scene painters ---- */
  const S = {};
  S.title = (f) => { sky(true); mountains(70, [[30, 40], [70, 22], [110, 50], [150, 30], [190, 12], [230, 44], [260, 34]], C.g); ground(70, f); caravan(50, 70, f, true); sun(250, 12, C.w); text("THE SINAI TRAIL", 60, 22, C.g, 14); text("From the Sea of Reeds to Jericho", 52, 34, C.w, 7); };
